...
class VanityAddressGeneratorTest(TestCase):
    ...
    def test_generate_address_gets_the_addresses_of_the_public_keys(self, generate_private_key, public_key):
        generate_private_key.side_effect = self._private_keys
    ...
    def test_generate_address_tries_to_match_the_pattern_with_the_addresses(self, generate_private_key, public_key):
        generate_private_key.side_effect = self._private_keys
    ...
    def test_generate_address_returns_the_first_matching_address(self, generate_private_key, public_key):
        generate_private_key.side_effect = self._private_keys
        public_key.return_value.get_address.side_effect = self._addresses

        address = self._vanity_address_generator.generate_address(self._pattern)
